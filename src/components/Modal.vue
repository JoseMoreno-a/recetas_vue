              ...
              <div>
                <div class="mt-3">
                    ...
                    <div class="px-8">
                        ...
                        <p v-if="bebidas.receta.strInstructionsES" class="text-lg text-gray-500"><span class="text-orange-600">Español:</span> {{ bebidas.receta.strInstructionsES
                        }}</p>
                        <p v-if="bebidas.receta.strInstructionsES" class="text-orange-600">---------------------------------------------------------------------------------------</p>
                        <p v-if="bebidas.receta.strInstructions" class="text-lg text-gray-500"><span class="text-orange-600">Ingles:</span> {{ bebidas.receta.strInstructions
                        }}</p>
                    </div>
