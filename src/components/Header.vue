...
<template>
    ...
    >
        <div class="mx-auto container px-10 py-16">
            ...
            >
                ...
                <input  
                    type="submit"
                    class="bg-orange-800 hover:bg-orange-900 cursor-pointer text-white font-extrabold uppercase p-2 w-full rounded-lg"
